...
function multiBase(num: number, base: number) {
  const s = new Stack();
  do {
    s.push(num % base);
...
const checkBracket = (expression: string) => {
...
const pezDispenser = (colors: Array<string>, remove: string) => {
...
console.log(
  pezDispenser(["red", "yellow", "green", "purple", "brown"], "yellow")
);
